...
resource "aws_iam_role" "cluster" {
  name = "${var.project_name}-${var.environment}-cluster-role-${var.region}"
...
resource "aws_iam_role" "node_group" {
  name = "${var.project_name}-${var.environment}-node-group-role-${var.region}"
...
resource "aws_iam_openid_connect_provider" "cluster" {
  ...
  tags = merge(var.tags, {
    Name = "${var.project_name}-${var.environment}-${var.region}-oidc"
  })
}
...
resource "aws_security_group" "cluster" {
  name_prefix = "${var.project_name}-${var.environment}-cluster-sg-${var.region}"
  vpc_id      = var.vpc_id
  ...
  tags = merge(var.tags, {
    Name = "${var.project_name}-${var.environment}-cluster-sg-${var.region}"
  })
}
...
resource "aws_eks_node_group" "main" {
  ...
  node_group_name = "${var.project_name}-${var.environment}-${each.key}-${var.region}"
  ...
  tags = merge(var.tags, {
    Name = "${var.project_name}-${var.environment}-${each.key}-${var.region}"
  })
}